package org.example.hibernate.practice;

import org.example.hibernate.demo.model.Person;
import org.example.hibernate.demo.model.Phone;
...
/*
 * 1) Сделать так, чтобы метод throwLazyException генерировал исключение org.org.example.hibernate.LazyInitializationException
 *
 * */
