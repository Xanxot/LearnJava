...
public class TimerMain {
    ...
    public static void main(String[] args) throws Exception {
        new org.example.timer.TimerMain().start();
    }
    ...
    private void start() throws Exception {
        ...
        context.addServlet(new ServletHolder(new org.example.timer.TimerServlet()), "/timer");
    ...
    private void resourcesExample() {
        URL url = org.example.timer.TimerMain.class.getResource(PUBLIC_HTML + "/index.html"); //local path starts with '/'
